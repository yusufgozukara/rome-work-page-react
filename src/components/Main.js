...
function Main(){
    return(
        <main>
            ...
            <p>Kolezyum ya da Flavianus Amfitiyatro, İtalya'nın başkenti Roma'da bulunan oval bir amfitiyatrodur.Usta bir komutan olan Vespasianus tarafından MS 72 yılında yapımına başlandı ve MS 80 yılında Titus döneminde tamamlandı.Daha sonraki değişiklikler Domitian hükümdarlığı zamanında yapılmıştır.Kolezyum traverten kireçtaşı, tüf (volkanik kaya) ve tuğla kaplı betondan yapılmıştır.
              Kolezyum, tarihinin çeşitli noktalarında yaklaşık 50.000 ila 80.000 seyirciyi ağırlayabilmiştir. İmparatorlar burada Roma halkını eğlendirmek için ve biraz da kendi eğlenceleri için gladyatör dövüşleri düzenlerdi. Bunlardan başka pek çok halk gösterileri, deniz savaşları, hayvan avcılığı, infazlar, meşhur savaşların yeniden canlandırılması, klasik mitolojiye dayanan dramalar olurdu. Kolezyum daha sonra barınma yeri, iş dükkânları, dini kışlalar, istiham, taş ocağı, Hristiyan türbesi olarak çeşitli amaçlarla kullanıldı. Asıl adı Arena iken, sonradan, girişteki heykelin adını aldı.</p>
              <button className="chlan">Dili Değiştir / Change the Language</button><br /><br />
